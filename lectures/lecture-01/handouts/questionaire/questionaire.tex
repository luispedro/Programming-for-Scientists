...
\header{This is also a self-test. If you answer ``Use it always'' to all these questions, then you might be over-qualified for this class.  On the other hand, if you do not regularly use these tools, then this class might help you a lot.}
