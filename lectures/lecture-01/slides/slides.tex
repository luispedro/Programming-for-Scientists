...
\item Course Website: http://\ldots
...
\item Homeworks are to be turned in by email in text (.txt) or pdf format for the questions, and Python code for the programming (.py files). In particular, \textbf{doc, docx, odt} will not be accepted.
\end{itemize}
\end{block}
}
...
\frame{\frametitle{Structured Programming}
